...
<template>
    <SeoHead :title="title" :description="description" :og-image="ogImage"
             :preload-image="product.gallery?.[0]?.large"
             :preload-srcset="product.gallery?.[0] ? `${product.gallery[0].card} 800w, ${product.gallery[0].large} 1080w, ${product.gallery[0].full} 1600w` : null"
        ...
        <div class="product__grid">
            ...
            <div class="product__info">
                ...
                <form v-else class="add-form" @submit.prevent="submit">
                    <input v-model="form.website" type="text" class="hp" tabindex="-1" autocomplete="off" aria-label="Leave empty" />
